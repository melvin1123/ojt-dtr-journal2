...
* **Developer 1 (Jerwin)** – Time-In / Time-Out (DTR Core)
* **Developer 2 (Ron)** – Weekly Journal Report System (JSON-based entries)
* **Developer 3 (Melvin)** – Admin Review, Certification & Audit Logs
